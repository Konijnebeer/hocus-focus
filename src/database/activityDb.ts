  ...
  try {
    ...
    const initialActivities: Activity[] = [
      // Yoga & stretching (low pressure, outdoor / community)
      {
        ...
        description:
          "A relaxed outdoor yoga session focused on breathing and gentle movement.",
      ...
      },
      {
        ...
        description:
          "Beginner-friendly yoga session with simple movements and a calm pace.",
      ...
      // Hiking / walking (very Finland-appropriate)
      {
        ...
        description:
          "A slow-paced walk through nearby forest paths. No experience needed.",
      ...
      // Pilates (low intensity, beginner friendly)
      {
        ...
        description:
          "Low-intensity pilates focused on mobility and core awareness.",
