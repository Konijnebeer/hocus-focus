  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "z-0 &:z-10 relative mx-auto my-4 [--hex-w:2em] w-(--hex-w) h-[calc(var(--hex-w)*1.732)] rounded-[calc(var(--hex-w)*0.1)/calc(var(--hex-w)*0.05)] bg-primary transition-opacity duration-500",
        // Pseudo-elements for hexagon
        "before:-z-10 before:absolute before:w-full before:h-full before:rounded-[inherit] before:bg-inherit before:content-[''] before:rotate-60",
        "after:-z-10 after:absolute after:w-full after:h-full after:rounded-[inherit] after:bg-inherit after:content-[''] after:-rotate-60",
