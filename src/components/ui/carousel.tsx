  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "z-0 absolute mx-auto my-4 [--hex-w:1.2em] w-[var(--hex-w)] h-[calc(var(--hex-w)*1.732)] rounded-[calc(var(--hex-w)*0.1)/calc(var(--hex-w)*0.05)] bg-secondary hover:bg-sidebar-ring transition-all duration-200",
